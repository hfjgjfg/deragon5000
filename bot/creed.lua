...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {199433012,150575718},--Sudo users
    disabled_channels = {},
    ...
    ‼️ this bot is made by : sorblack_2
   〰〰〰〰〰〰〰〰
   ߔࠀ   our admins are : 
   ߔࠀ   @tele_deragon_admin
...
کانال ما : https://telegram.me/tele_deragon

اعضای اصلی ما : 

@sorblack_2 [سازنده]
@tele_deragon_admin [عضو اصلی ]
